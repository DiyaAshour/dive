...
type Props = Readonly<{hotel: HotelbedsHotelDetails; offer: HotelbedsOffer; arrival: string; departure: string; adults: number; children: number; childrenAges: readonly number[]; locale: GuestLocale; currency: GuestCurrency; onlinePaymentAvailable: boolean}>;

export function HotelbedsCheckoutFlow({hotel, offer, arrival, departure, adults, children, childrenAges, locale, currency, onlinePaymentAvailable}: Props) {
