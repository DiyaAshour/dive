...
import { getHotelPublicContentForManagement, getHotelWorkspace, getPublishingReadiness, listUserHotels } from "@platform/server";
...
export default async function HotelDashboard({searchParams}: {searchParams: Promise<{hotelId?: string}>}) {
  ...
  const [workspace, publicContent, readiness] = await Promise.all([
