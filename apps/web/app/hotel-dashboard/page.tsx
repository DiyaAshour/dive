...
import { getHotelPublicContentForManagement, getHotelWorkspace, listUserHotels } from "@platform/server";
...
export default async function HotelDashboard({searchParams}: {searchParams: Promise<{hotelId?: string}>}) {
  ...
  const [workspace, publicContent] = await Promise.all([
