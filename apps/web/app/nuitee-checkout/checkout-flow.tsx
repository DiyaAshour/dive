...
type Props=Readonly<{hotelId:string;offerId:string;hotelName:string;city:string;arrival:string;departure:string;adults:number;children:number;childrenAges:number[];guestNationality:string;locale:GuestLocale;currency:GuestCurrency;refreshHref:string}>;
...
export function NuiteeCheckoutFlow(props:Props){
  const {hotelId,offerId,hotelName,city,arrival,departure,adults,children,childrenAges,guestNationality,locale,currency,refreshHref}=props;
