...
export async function GET(){
  ...
  const items=posts.map(post=>{
    const locale=blogLocalePath(post.locale);
  ...
  const body=`<?xml version="1.0" encoding="UTF-8"?><rss version="2.0"><channel><title>HandMeKey Travel Guide</title><link>${xml(siteUrl("/blog/en"))}</link><description>Jordan travel guides in English, Arabic and Spanish.</description><language>mul</language><lastBuildDate>${lastBuild.toUTCString()}</lastBuildDate><atom:link xmlns:atom="http://www.w3.org/2005/Atom" href="${xml(siteUrl("/feed.xml"))}" rel="self" type="application/rss+xml"/>${items}</channel></rss>`;
