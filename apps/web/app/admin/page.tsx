...
import { listPropertyReviewQueue, listUserHotels } from "@platform/server";
...
export default async function AdminPage(){
  ...
  const [hotels,reviews]=await Promise.all([listUserHotels(user.id),listPropertyReviewQueue(user.id)]);
