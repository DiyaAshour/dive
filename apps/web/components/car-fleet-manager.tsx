...
export function CarFleetManager({locale,initialVehicles,locations,currency}:Props){
  ...
  const copy=ar?{
    title:"الأسطول",body:"اربط كل سيارة بمكتبة HandMeKey القياسية ثم أضف بيانات التأجير والصور الحقيقية الخاصة بسيارتك.",add:"إضافة سيارة",close:"إغلاق",save:"حفظ السيارة",saving:"جارٍ الحفظ...",
    basicTitle:"بيانات السيارة",basicBody:"اختر السيارة الدقيقة من المكتبة أولًا. إذا لم تكن موجودة يمكنك إدخالها يدويًا مؤقتًا.",rentalTitle:"التأجير والسعر",rentalBody:"السعر والوديعة وموقع الاستلام الأساسي.",extrasTitle:"مزايا العرض",extrasBody:"حدد ما يشمله العرض. بعد الحفظ أضف الصور الحقيقية من زر إدارة الصور.",
    make:"الماركة",model:"الموديل",year:"السنة",category:"الفئة",transmission:"ناقل الحركة",fuel:"الوقود",seats:"المقاعد",bags:"الحقائب",price:"السعر اليومي",deposit:"الوديعة",location:"الفرع الأساسي",freeCancel:"إلغاء مجاني",unlimited:"كيلومترات غير محدودة",airport:"استلام من المطار",automatic:"أوتوماتيك",manual:"عادي",empty:"لا توجد سيارات في الأسطول بعد",emptyBody:"أضف أول سيارة واربطها بالمكتبة القياسية حتى تصبح الصور والـ360° موحدة على الموقع.",failed:"تعذر حفظ السيارة.",required:"إلزامي",depositHint:"يجب تحديد وديعة أكبر من صفر لكل سيارة ولكل شركة، بدون استثناء.",stored:"اختيار السيارة من المكتبة يربطها بهوية مرئية موحدة. الصور التي ترفعها الشركة تبقى منفصلة كصور حقيقية للمركبة.",depositMissing:"الوديعة مطلوبة",photos:"إدارة الصور",catalog:"Catalog",visual360:"360°"
  }:{
    title:"Fleet",body:"Link every fleet car to the HandMeKey standardized vehicle library, then add rental terms and real supplier photos.",add:"Add vehicle",close:"Close",save:"Save vehicle",saving:"Saving...",
    basicTitle:"Vehicle details",basicBody:"Choose the exact vehicle from the library first. If it is not listed yet, you can enter it manually for now.",rentalTitle:"Rental & pricing",rentalBody:"Daily rate, mandatory deposit and primary pickup location.",extrasTitle:"Offer features",extrasBody:"Choose what the offer includes. After saving, add real supplier photos from Manage photos.",
    make:"Make",model:"Model",year:"Year",category:"Category",transmission:"Transmission",fuel:"Fuel",seats:"Seats",bags:"Bags",price:"Daily price",deposit:"Deposit",location:"Home location",freeCancel:"Free cancellation",unlimited:"Unlimited mileage",airport:"Airport pickup",automatic:"Automatic",manual:"Manual",empty:"No vehicles in the fleet yet",emptyBody:"Add the first vehicle and link it to the standardized library so imagery and 360° experiences stay consistent across the site.",failed:"Could not save the vehicle.",required:"Required",depositHint:"A deposit greater than zero is mandatory for every vehicle and every rental company, with no exceptions.",stored:"Choosing a library vehicle links it to a standardized visual identity. Supplier uploads remain separate as real photos of the rental car.",depositMissing:"Deposit required",photos:"Manage photos",catalog:"Catalog",visual360:"360°"
  };
